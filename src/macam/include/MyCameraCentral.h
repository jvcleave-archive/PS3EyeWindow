...
@property(readwrite,assign)BOOL cameraGrabbing;
@property(readwrite,assign)CameraResolution cameraResolution;
@property(readwrite,assign)int cameraWidth;
@property(readwrite,assign)int cameraHeight;
@property(readwrite,assign)int cameraFPS;
